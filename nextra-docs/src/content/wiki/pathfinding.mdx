...
<RelatedPages pages={[
  { title: "Cow", description: "See herd navigation in action", href: "/wiki/animals/cow" },
  { title: "Sheep", description: "Watch flock movement patterns", href: "/wiki/animals/sheep" },
  { title: "Rabbit", description: "Observe fleeing and evasion", href: "/wiki/animals/rabbit" },
  { title: "Behavior System", description: "Technical details on animal AI", href: "/systems/behavior-system" }
]} />
