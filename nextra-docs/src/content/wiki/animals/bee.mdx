...
<div style={{
  ...
  <div style={{ fontSize: '1.2em', fontWeight: 'bold', marginBottom: '12px', color: '#8B4513' }}>
    BEE
  </div>
  <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr', gap: '8px', color: '#654321' }}>
    <div><strong>Health:</strong></div>
    <div>5 hearts</div>
    <div><strong>Special:</strong></div>
    <div>Waggle Dance communication</div>
    <div><strong>Produces:</strong></div>
    <div>Honey, Honeycomb</div>
    <div><strong>Warning:</strong></div>
    <div>Will sting if provoked!</div>
  </div>
</div>
