...
<RelatedPages
  pages={[
    { title: 'Wolf', href: '/docs/wiki/animals/wolf', description: 'Fellow predator of the wilderness' },
    { title: 'Chicken', href: '/docs/wiki/animals/chicken', description: 'Prime target for fox hunts' },
    { title: 'Rabbit', href: '/docs/wiki/animals/rabbit', description: 'Challenging prey with zigzag fleeing' },
    { title: 'Predation Behavior', href: '/docs/research/overview', description: 'Learn about hunting mechanics' }
  ]}
/>
