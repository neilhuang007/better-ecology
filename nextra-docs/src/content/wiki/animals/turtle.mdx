...
<div style={{
  ...
  <div style={{ fontSize: '1.2em', fontWeight: 'bold', marginBottom: '12px', color: '#2E8B57' }}>
    TURTLE
  </div>
  <div style={{ display: 'grid', gridTemplateColumns: '140px 1fr', gap: '8px', color: '#1F5F3F' }}>
    <div><strong>Health:</strong></div>
    <div>15 hearts</div>
    <div><strong>Drops:</strong></div>
    <div>Scute (baby to adult), Seagrass (breeding)</div>
    <div><strong>Special:</strong></div>
    <div>Beach nesting, Basking behavior</div>
    <div><strong>Habitat:</strong></div>
    <div>Beaches and oceans</div>
    <div><strong>Movement:</strong></div>
    <div>Slow on land, fast in water</div>
  </div>
</div>
...
**Tip:** Build a nice sandy beach with plenty of open space. Turtles will naturally find the sunniest spots and make them their regular basking areas throughout the day.
...
**Did you know?** A turtle's home beach is set when they're born. Even if you move them far away, they'll always remember and try to return to that original location when it's time to nest.
...
**Tip:** Mark turtle nesting areas with subtle boundaries like fences or lighting to help protect the eggs from being trampled. Just make sure the mother turtle can still access the sand!
...
**Try this:** Stay near a turtle nest as night falls when the eggs are close to hatching. You might see multiple baby turtles all rushing to the water together in a tiny migration. It's one of the most heartwarming sights in Minecraft!
...
**Tip:** Want to help baby turtles survive? Light up the beach area and clear away threats before they hatch. Or create a protected path from the nest to the water using fences or blocks.
...
**Did you know?** In the water, turtles are faster than they are on land. If you're trying to follow a turtle, you'll have a much easier time keeping up when they're on the beach!
...
**Try this setup:** Find a warm ocean biome with a nice beach. Clear away any obstacles on the sand, plant seagrass in the shallow waters nearby, and fence off a nesting area while keeping it accessible to turtles. Light up the area to prevent hostile mob spawns at night.
