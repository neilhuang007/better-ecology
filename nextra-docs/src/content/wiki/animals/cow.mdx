...
<RelatedPages pages={[
  { title: "Sheep", description: "Another herding animal with flock behavior", href: "/wiki/animals/sheep" },
  { title: "Pig", description: "Fellow farm animal with foraging behaviors", href: "/wiki/animals/pig" },
  { title: "Passive Mobs", description: "Overview of all passive animals", href: "/wiki/animals" },
  { title: "Herd Movement", description: "Learn how herding works", href: "/research/herd-movement" }
]} />
