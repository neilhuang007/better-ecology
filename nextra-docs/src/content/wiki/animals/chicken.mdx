...
<RelatedPages
  pages={[
    { title: "Parrot", description: "Another feathered friend", href: "/wiki/animals/parrot" },
    { title: "Fox", description: "Natural chicken predator", href: "/wiki/animals/fox" },
    { title: "Sheep", description: "Another flocking farm animal", href: "/wiki/animals/sheep" }
  ]}
/>
