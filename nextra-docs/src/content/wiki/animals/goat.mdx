...
<AnimalInfoBox
  ...
  health="5 hearts"
  habitat="Mountains"
  diet="Herbivore (wheat)"
  temperament="Aggressive (ramming)"
  color="#A0522D"
  specialAbilities={[
    "Can jump 10 blocks high",
    "Rams mobs and blocks",
    "Screaming variant exists",
    "Drops horns when ramming"
  ]}
/>
...
Try following a goat up a mountain - you'll struggle to keep up! These fearless climbers make mountain peaks look easy.
</HintBox>

<HintBox type="didYouKnow">
Goats can jump 10 blocks high! That's right - TEN BLOCKS! This incredible jumping ability lets them navigate mountain peaks that other animals can't reach.
</HintBox>
...
<HintBox type="hint">
Keep your distance from goats if you're near cliff edges. A well-timed ram can send you flying off a mountain!
</HintBox>
...
<HintBox type="didYouKnow">
Kids grow up to become either regular goats or screaming goats, inheriting their personality from birth. A screaming kid will always become a screaming adult!
</HintBox>
...
<HintBox type="tryThis">
Set up ramming targets! Build a wall of solid blocks in an area where goats roam. Eventually, their natural ramming behavior will cause them to charge the wall, and you might collect some horns!
</HintBox>
...
<RelatedPages
  pages={[
    ...
    { title: 'Rabbit', href: '/docs/wiki/animals/rabbit' },
    { title: 'Flocking Behavior', href: '/docs/research/flocking' }
  ]}
/>
